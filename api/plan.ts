...
Верни ТОЛЬКО JSON: {"name":"5ж","kind":"жилая","area_m2":13.9,"width_cm":372,"depth_cm":408,"walls":[{"side":"top","at":0.5,"cm":372},{"side":"left","at":0.5,"cm":408},{"side":"bottom","at":0.9,"cm":82},{"side":"right","at":0.8,"cm":150}],"openings":[{"kind":"door","side":"right","at":0.85,"width_cm":80}],"note":"размер 4.08 подписан у левой стены"}
...
- walls — ВСЕ размеры, подписанные вдоль стен этой комнаты, включая короткие у ниш, выступов и уступов («0.26», «0.68», «1.29») и размеры коридора у Г-образной комнаты. side — у какой стороны комнаты стоит число (у стены или уступа, который оно меряет: верхняя, правая, нижняя, левая; у ступеньки внизу выреза — bottom), at — где середина числа вдоль этой стороны: 0..1 слева направо или сверху вниз по всему куску; cm — число в сантиметрах. Ширину и глубину комнаты тоже перечисли здесь.
- openings — все двери и окна в стенах этой комнаты. Пройди по каждой из четырёх стен. На плане БТИ окно — несколько параллельных тонких линий поперёк наружной стены или рамка с линиями снаружи неё; дверь — разрыв в стене, иногда с дугой открывания; проём без двери — разрыв без дуги. kind door, window или doorway; side — в какой стене (top, right, bottom, left); at — где вдоль неё, 0..1 слева направо или сверху вниз.
- Соседние комнаты закрашены белым. Их подписи не бери. Если своей подписи (номера или площади) внутри комнаты нет, name и area_m2 не заполняй — не бери номер соседа и не выдумывай.
