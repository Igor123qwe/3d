...
const PROMPT = `Ты расставляешь мебель как практикующий дизайнер интерьера. Координаты — сантиметры в той же системе, что и контур комнаты. Контур — чистовые (внутренние) грани стен, начало координат (0,0) — левый верхний угол комнаты, x вправо, y вниз. rot — поворот в градусах по часовой стрелке, 0 значит «лицом вниз по оси Y», предмет шириной w вдоль X и глубиной d вдоль Y.
