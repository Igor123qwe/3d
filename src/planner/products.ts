...
// порядок важен: частное раньше общего («тумба под ТВ» раньше «тумб», «стол письменный» раньше «стол»)
const TYPE_BY_NAME: [RegExp, string][] = [
  [/холодильник|refrigerator|fridge/i, 'fridge'],
  [/стиральн|сушильн/i, 'washer'],
  [/посудомоечн/i, 'dishwasher'],
  [/микроволнов|свч/i, 'box'],
  [/духов|плита|варочн/i, 'stove'],
  [/вытяжк/i, 'box'],
  [/кухонн\w* гарнитур|столешниц/i, 'counter-100'],
  [/мойка|раковина кухонн/i, 'sink'],
  [/унитаз|биде/i, 'toilet'],
  [/ванна(?!я комната)/i, 'bathtub-170'],
  [/душев/i, 'shower-90'],
  [/полотенцесуш/i, 'towel-rail'],
  [/раковин|умывальник/i, 'basin'],
  [/диван.?углов|углов\w* диван/i, 'sofa-corner'],
  [/диван/i, 'sofa-3'],
  [/кресло.?офис|офисн\w* кресло|компьютерн\w* кресло/i, 'office-chair'],
  [/кресло/i, 'armchair'],
  [/кровать|матрас/i, 'bed-160'],
  [/шкаф.?купе/i, 'wardrobe-slide'],
  [/шкаф|гардероб/i, 'wardrobe'],
  [/комод/i, 'dresser'],
  [/тумб\w* (под|для) тв|тв-тумб|тумба тв|под телевизор/i, 'tv-stand'],
  [/тумб/i, 'nightstand'],
  [/стеллаж|полк/i, 'bookshelf'],
  [/письменн|компьютерн\w* стол|рабоч\w* стол|стол (письменный|компьютерный|рабочий)/i, 'desk'],
  [/журнальн/i, 'coffee-table'],
  [/обеденн|стол/i, 'dining-table'],
  [/барн\w* (стул|табурет)|стул барный/i, 'bar-stool'],
  [/стул|табурет/i, 'chair'],
  [/телевизор|tv/i, 'tv'],
  [/ковёр|ковер/i, 'rug'],
  [/зеркал/i, 'mirror'],
  [/радиатор|батаре/i, 'radiator'],
  [/торшер/i, 'lamp'],
  [/светильник|люстра|лампа|бра/i, 'light'],
  [/скамь|банкетк/i, 'bench'],
  [/вешалк/i, 'hanger'],
  [/растен|цветок|фикус/i, 'plant'],
  [/пианино|рояль/i, 'piano'],
]
