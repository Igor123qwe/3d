...
Что в сегментации сделано против типичных бед фотографий (`raster.ts`): радиус закрытия проёмов подбирается **голосованием по пяти радиусам** — настоящая комната находится почти при любом, случайная область (цифры на полях, миниатюра в углу скрина) при одном; поле листа вокруг плана **срезается полосами** вдоль краёв, пока не останется комната, подтёкшая в него через обрезанный край фото; **Г-образная область** режется по ступеньке профиля на две комнаты (кухня и коридор без двери), а если рамка комнаты накрыла угол, куда заходит коридор, комната **уступает угол** тому, чьи точки там лежат (`yieldsTo`), и на чертеже выходит Г-образной — без выдуманной клетки в углу. Площадь области считается по рамке до стен с поправкой на заполнение, а не по съеденным закрытием точкам — иначе масштаб по площадям уезжал на треть.

**Картинка — правда для геометрии, цифры — для масштаба и проверки.** Если комнаты нашлись на картинке, стены встают ровно туда, где они на фото: общая стена посередине щели между соседями, её толщина равна щели, пустая полоса между двумя комнатами (шахта) — одна толстая стена, а не две с дырой. Прочитанные цифры стены не двигают. Раньше решатель подгонял оси под подписи, и одна неверно прочитанная цифра уводила комнату за край фото и рождала щели-«кладовые». Решатель по числам остался для плохих фото, где комнат с картинки не нашлось.
