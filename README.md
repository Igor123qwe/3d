...
| `raster.ts` | Подготовка фото: выравнивание фона, бинаризация, удаление мелких меток, угол наклона (Шарр), поворот, гомография по 4 углам, преобразование расстояния и комната по клику. |
