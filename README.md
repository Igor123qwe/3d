...
Браузер откроется сам. Если проекта рядом нет, скрипт сначала склонирует его. Повторный запуск не переустанавливает зависимости зря — только когда изменился `package-lock.json`.
...
| `start.cmd`, `start.sh` | Обновить из git, доставить зависимости и запустить. |
