...
5. **Электрика.** Вкладка «⚡», включите «Умный дом» и остальные правила, нажмите «Расставить». Внизу появится ведомость с количеством приборов, высотами и оценкой кабеля.
6. **3D.** Кнопка «3D / AR»: объёмная сцена, «Стены: прозрачные» открывает вид сверху, клик по предмету выбирает его.
