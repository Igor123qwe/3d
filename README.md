...
- **План можно загрузить как угодно**: перетащить картинку или файл плана в любое место окна, вставить скриншот по Ctrl+V, выбрать файл. Путь один, приёмник общий — картинка становится подложкой, JSON открывается как план.
...
1. **Своя схема.** На стартовом экране — «Загрузить свой план»: перетащите скриншот или фото плана в окно, нажмите «Выбрать файл» или вставьте из буфера по Ctrl+V. Панель справа поведёт по шагам: получить стены (с ИИ или обводкой линий), проверить масштаб, убрать подложку.
